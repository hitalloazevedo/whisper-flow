...
import { AudioLines, CheckCircle2, Clock3, FileAudio, LogOut, Plus, ShieldCheck, UploadCloud } from 'lucide-react'
...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" className="google-icon" viewBox="0 0 24 24">
      <path fill="#4285F4" d="M21.35 12.23c0-.74-.07-1.45-.2-2.13H12v4.03h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.15c1.84-1.7 2.9-4.2 2.9-7.29Z" />
      <path fill="#34A853" d="M12 21.8c2.63 0 4.84-.87 6.45-2.36l-3.15-2.45c-.87.58-1.98.92-3.3.92-2.54 0-4.7-1.72-5.47-4.03H3.28v2.53A9.74 9.74 0 0 0 12 21.8Z" />
      <path fill="#FBBC05" d="M6.53 13.88a5.86 5.86 0 0 1 0-3.76V7.59H3.28a9.8 9.8 0 0 0 0 8.82l3.25-2.53Z" />
      <path fill="#EA4335" d="M12 6.09c1.43 0 2.71.49 3.72 1.46l2.79-2.79C16.84 3.2 14.63 2.3 12 2.3a9.74 9.74 0 0 0-8.72 5.29l3.25 2.53C7.3 7.81 9.46 6.09 12 6.09Z" />
    </svg>
  )
}
  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        ...
        {isSignedIn && <div className="account-area">
      ...
      {!isSignedIn ? (
        <section className="auth-page">
          <div className="auth-panel">
            <span className="auth-mark"><AudioLines size={22} /></span>
            ...
            <p className="auth-legal">By continuing, you agree to keep your recordings private and secure.</p>
          </div>
        </section>
      ) : (
        <>
