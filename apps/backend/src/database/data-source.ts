...
import { WorkerHeartbeat } from '../health/worker-heartbeat.entity'
...
import { CreateWorkerHeartbeats1790000000000 } from './migrations/1790000000000-CreateWorkerHeartbeats'

export const AppDataSource = new DataSource({
  type: 'postgres',
  url: process.env.DATABASE_URL,
  entities: [User, OAuthAccount, Job, WorkerHeartbeat],
  migrations: [
    ...
    CreateWorkerHeartbeats1790000000000,
  ],
  synchronize: false,
})
